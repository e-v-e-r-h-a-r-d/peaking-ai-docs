...
description: Cómo usar la bandeja de mensajes para gestionar las conversaciones asignadas a tu equipo humano.
sidebar:
  order: 4
---
...
:::tip[No repitas lo que ya dijo el agente]
Revisa el historial antes de responder. El agente ya puede haber dado información básica al cliente. Empieza donde el agente se quedó.
:::

...
2. Selecciona la pestaña o sección **Información de Conversaciones**.
3. Verás la interfaz de chat del agente con preguntas de ejemplo.

---

## Cómo funciona

El agente analiza el historial completo de conversaciones de tu cuenta y responde preguntas en español (o en el idioma que uses). No necesitas aprender comandos especiales — escribe tu pregunta como lo harías con un colega.
...
La interfaz muestra preguntas de ejemplo para empezar:
...
1. Haz clic en una **pregunta de ejemplo** para usarla directamente, o escribe tu propia pregunta en el campo de texto inferior.
2. El campo placeholder dice: *"Pregúntame sobre las conversaciones de tus clientes..."*
3. Envía tu pregunta con el botón de envío (ícono de flecha).
4. El agente analiza las conversaciones y responde con un análisis detallado.
5. Puedes hacer preguntas de seguimiento para profundizar en un tema específico.

:::tip[Sé específico para mejores resultados]
En lugar de "¿cómo están los clientes?", pregunta "¿cuáles son las preguntas más frecuentes sobre envíos en los últimos 30 días?". Las preguntas más acotadas generan análisis más útiles.
:::
...
**¿Qué historial de conversaciones analiza el agente?**
...
El agente basa sus respuestas en el contenido real de las conversaciones. Los análisis cualitativos son interpretaciones — el agente identifica patrones y tendencias, no hace conteos exactos. Para métricas numéricas precisas (cantidad de conversaciones, tasas), usa el [Dashboard overview](/08-analytics/dashboard-overview/).
